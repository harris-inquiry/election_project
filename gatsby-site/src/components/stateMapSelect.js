  ...
  return (
    <div id="state-svg" style={style}>
      <svg xmlns="http://www.w3.org/2000/svg" onClick={(evt) => onClick(evt.target)} width="100%" height="100%" preserveAspectRatio="xMinYMin meet" viewBox="0 0 930 620">
        ...
        <path id="frames" fill="none" stroke="#1d1e7d" strokeWidth="2" d="M215 493v55l36 45M0 425h147l68 68h85l54 54v46"/>
      </svg>
