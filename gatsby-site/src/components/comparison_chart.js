    ...
    <Table hover>
      ...
      <tbody>
        <tr class="comparisonRow diff" id="row1">
          ...
          <td id="valtd1_1" class="vcol">Liberal, left-leaning.</td>
          <td id="valtd1_2" class="vcol">Conservative, right-leaning.</td>
        </tr>
        <tr class="comparisonRow diff" id="row2">
          <th class="acol" scope="row">Economic Ideas</th>
          <td id="valtd2_1" class="vcol">Minimum wages and progressive taxation, i.e., higher tax rates for
            higher income brackets. Born out of anti-federalist ideals but evolved over time to favor more
            government regulation.</td>
          <td id="valtd2_2" class="vcol">Believe taxes shouldn't be increased for anyone (including the
        ...
        <tr class="comparisonRow diff" id="row3">
          ...
          <td id="valtd3_1" class="vcol">Based on community and social responsibility</td>
          <td id="valtd3_2" class="vcol">Based on individual rights and justice</td>
        </tr>
        <tr class="comparisonRow diff" id="row4">
          <th class="acol" scope="row">Stance on Military issues</th>
        ...
        <tr class="comparisonRow diff" id="row5">
          ...
          <td id="valtd5_1" class="vcol">Support (some Democrats disagree)</td>
          <td id="valtd5_2" class="vcol">Oppose (some Republicans disagree)</td>
        </tr>
        <tr class="comparisonRow diff" id="row6">
          <th class="acol" scope="row">Stance on Abortion</th>
          <td id="valtd6_1" class="vcol">Should remain legal; support Roe v. Wade</td>
          <td id="valtd6_2" class="vcol">Should not be legal (with some exceptions); oppose Roe v. Wade</td>
        </tr>
        <tr class="comparisonRow diff" id="row7">
          <th class="acol" scope="row">Stance on Death Penalty</th>
          <td id="valtd7_1" class="vcol">While support for the death penalty is strong among Democrats,
            opponents of the death penalty are a substantial fraction of the Democratic base.</td>
          <td id="valtd7_2" class="vcol">A large majority of Republicans support the death penalty.</td>
        </tr>
        <tr class="comparisonRow diff" id="row8">
          <th class="acol" scope="row">Stance on Taxes</th>
          <td id="valtd8_1" class="vcol">Progressive (high income earners should be taxed at a higher rate).
            Generally not opposed to raising taxes to fund government.</td>
          <td id="valtd8_2" class="vcol">Tend to favor a "flat tax" (same tax rate regardless of income).
            Generally opposed to raising taxes.</td>
        </tr>
        <tr class="comparisonRow diff" id="row9">
          <th class="acol" scope="row">Stance on Government Regulation</th>
          <td id="valtd9_1" class="vcol">Government regulations are needed to protect consumers.</td>
          <td id="valtd9_2" class="vcol">Government regulations hinder free market capitalism and job
            growth.</td>
        </tr>
        <tr class="comparisonRow diff" id="row10">
          <th class="acol" scope="row">Healthcare Policy</th>
          <td id="valtd10_1" class="vcol">Support universal healthcare; strong support of government
            involvement in healthcare, including Medicare and Medicaid. Generally support Obamacare.</td>
          <td id="valtd10_2" class="vcol">Private companies can provide healthcare services more efficiently
        ...
        <tr class="comparisonRow diff" id="row11">
          ...
          <td id="valtd11_1" class="vcol">There is greater overall support in the Democratic party for a
          ...
          <td id="valtd11_2" class="vcol">Republicans are generally against amnesty for any undocumented
